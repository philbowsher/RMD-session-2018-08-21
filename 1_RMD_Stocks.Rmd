...
The stock closed `r ifelse(open>close,'up','down')` at `r close` dollars per share yesterday ... hey this Phil 8/21/2018 Have a great day!!!

## Price History

The chart below is made with the `quantmod` R package, a widely used package for collecting and visualizing financial data in R. You can learn more about `quantmod` at its website.
***
